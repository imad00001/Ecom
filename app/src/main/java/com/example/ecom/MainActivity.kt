...
//    }
//
//    private fun uploadImage(uri: Uri, folder: String, onResult: (String?) -> Unit) {
...
//            .addFormDataPart("folder", folder) // 👈 This is the key!
//            .build()
//
//        val request = Request.Builder()
//            .url("https://api.cloudinary.com/v1_1/dawdgbh88/image/upload")
//            .post(requestBody)
//            .build()
//
